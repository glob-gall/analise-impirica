...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("37.78", valores_entrada,self.file))

    def test_verificar_string_2(self):
        valores_entrada = ["C", "320.0"]
        self.assertTrue(verificar_string("608.0", valores_entrada,self.file))

    def test_verificar_string_3(self):
        valores_entrada = ["F", "30.0"]
        self.assertTrue(verificar_string("-1.11", valores_entrada,self.file))
