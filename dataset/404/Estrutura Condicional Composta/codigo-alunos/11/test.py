...
def verificar_string(string1, valores_entrada):
    ...
    with open('3451_1397_2927.py', 'r') as file:
        codigo = file.read()
...
class TestStringVerification(unittest.TestCase):
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("54000.0", valores_entrada))

    def test_verificar_string_2(self):
        valores_entrada = ["5555.55"]
        self.assertTrue(verificar_string("27777.75", valores_entrada))

    def test_verificar_string_3(self):
        valores_entrada = ["95000.0"]
        self.assertTrue(verificar_string("390000.0", valores_entrada))
