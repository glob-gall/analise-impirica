...
def verificar_string(string1, valores_entrada):
    ...
    with open('3451_1395_2927.py', 'r') as file:
        codigo = file.read()
...
class TestStringVerification(unittest.TestCase):
    def test_verificar_string_1(self):
        valores_entrada = ["2000.0"]
        self.assertTrue(verificar_string("150.0", valores_entrada))

    def test_verificar_string_2(self):
        valores_entrada = ["835.6"]
        self.assertTrue(verificar_string("41.78", valores_entrada))

    def test_verificar_string_3(self):
        valores_entrada = ["10000"]
        self.assertTrue(verificar_string("950.0", valores_entrada))
