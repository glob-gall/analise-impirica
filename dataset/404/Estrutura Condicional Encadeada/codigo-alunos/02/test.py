...
class TestStringVerification(unittest.TestCase):
    ...
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("Entradas: 2.0 , 2.0 , 3.0", "Tipo de triangulo: isosceles", valores_entrada,self.file))

    def test_verificar_string_2(self):
        valores_entrada = ["4.2", "4.2", "4.2"]
        self.assertTrue(verificar_string("Entradas: 4.2 , 4.2 , 4.2", "Tipo de triangulo: equilatero", valores_entrada,self.file))

    def test_verificar_string_3(self):
        valores_entrada = ["3.0", "4.0", "5.0"]
        self.assertTrue(verificar_string("Entradas: 3.0 , 4.0 , 5.0", "Tipo de triangulo: escaleno", valores_entrada,self.file))
