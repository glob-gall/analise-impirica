...
def verificar_string(string1, valores_entrada):
    ...
    with open('3508_1487_2927.py', 'r') as file:
        codigo = file.read()
...
class TestStringVerification(unittest.TestCase):
    def test_verificar_string_1(self):
        valores_entrada = ["SALMAO", "10"]
        self.assertTrue(verificar_string("3000", valores_entrada))

    def test_verificar_string_2(self):
        valores_entrada = ["OMELETE", "-2"]
        self.assertTrue(verificar_string("Entrada invalida", valores_entrada))

    def test_verificar_string_3(self):
        valores_entrada = ["Nori", "12"]
        self.assertTrue(verificar_string("600", valores_entrada))
