...
def verificar_string(string1, valores_entrada):
    ...
    with open('3357_2938_1226.py', 'r') as file:
        codigo = file.read()
...
class TestStringVerification(unittest.TestCase):
    def test_verificar_string_1(self):
        ...
        self.assertTrue(verificar_string("16.42", valores_entrada))

    def test_verificar_string_2(self):
        valores_entrada = ["2.33", "4.09", "12.3"]
        self.assertTrue(verificar_string("1.88", valores_entrada))

    def test_verificar_string_3(self):
        valores_entrada = ["55.0", "3.0", "77.6"]
        self.assertTrue(verificar_string("54.43", valores_entrada))
